      ...
      docs: [
        {
          ...
          path: "https://github.com/brainded-tech/proofpix/blob/main/ARCHITECTURE.md",
          internal: false,
          badge: "Developers"
        },
        {
          ...
          path: "https://github.com/brainded-tech/proofpix/blob/main/API_REFERENCE.md",
          internal: false,
          badge: "Developers"
        },
        {
          ...
          path: "https://github.com/brainded-tech/proofpix/blob/main/TESTING_GUIDE.md",
          internal: false,
          badge: "Developers"
        },
        {
          ...
          path: "https://github.com/brainded-tech/proofpix/blob/main/DEPLOYMENT_GUIDE.md",
          internal: false,
          badge: "DevOps"
        }
      ]
        ...
        <section className="bg-gray-800/50 border border-gray-700 rounded-2xl p-8 mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <a
                href="https://github.com/brainded-tech/proofpix/blob/main/API_REFERENCE.md"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-400 hover:text-blue-300 underline text-sm"
              >
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <nav className="flex space-x-6 text-sm">
              ...
              <button onClick={() => navigate('/faq')} className="text-gray-400 hover:text-white">FAQ</button>
